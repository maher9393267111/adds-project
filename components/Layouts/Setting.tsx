    ...
    return (
        <div>
            ...
            >
                <button
                    type="button"
                    className="absolute top-0 bottom-0 hidden my-auto flex h-10 w-12 cursor-pointer items-center justify-center bg-primary text-white ltr:-left-12 ltr:rounded-tl-full ltr:rounded-bl-full rtl:-right-12 rtl:rounded-tr-full rtl:rounded-br-full"
