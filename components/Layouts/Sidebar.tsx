...
const Sidebar = () => {
    ...
    return (
        ...
        <div className={'dark'}>
            ...
            >
                <div className="h-full bg-black dark:bg-black">
                    ...
                    <div className="flex items-center justify-between gap-2 px-4 py-3">
                        <Link href="/" className="main-logo flex  flex-grow  items-center">
                            <img className="ml-[5px] w-[45%]  h-20 rounded-xlg flex-none object-contain" 
                                    ...
                                    <li className="nav-item">
                                        <Link href="/ads" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="!text-white ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark hover:text-[#506690]">ads</span>
                                            </div>
                                        </Link>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/usersAds" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="!text-white ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark hover:text-[#506690]">Users Table</span>
                                            </div>
                                        </Link>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/notifications" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="!text-white ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark hover:text-[#506690]">Notifications</span>
                                            </div>
                                        </Link>
                                    </li>
                                    </ul>
